...
const Home = () => {
  ...
  <div className='main'>
    ...
    <SimpleGrid marginTop="30px" backgroundColor="#00B7BC" height="660px"  columns={{base:1,md:2}} placeItems="center" spacing={10}>
      <Box>
      ...
      <Box width="90%" margin="auto" >
        ...
        <Text w="100%" paddingBottom="20px" >Our free PureGym app is one of the best ways to get started in the gym. Get access to way more support including personalised training plans, over 600 workouts and you can plan your visit at quieter times if you like with our live attendance tracker.</Text>
